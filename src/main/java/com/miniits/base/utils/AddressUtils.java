...
public class AddressUtils {
    ...
    public static Map<String, String> getAddress(String address) {
        ...
        String region = JSONObject.parseObject(address).get("region").toString();
        String city = JSONObject.parseObject(address).get("city").toString();
        String county = JSONObject.parseObject(address).get("county").toString();
        String isp = JSONObject.parseObject(address).get("isp").toString();
        String area = JSONObject.parseObject(address).get("area").toString();
