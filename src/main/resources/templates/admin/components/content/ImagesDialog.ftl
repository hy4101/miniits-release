<div class="modal fade" id="div_select_image_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <form id="category_form" name="category_form">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="h_select_image_modal_title" style="font-size: xx-large;">选择图片</h4>
                </div>
