...
;(function ($) {
    ...
    SelectPage.prototype.searchForDb = function (self, q_word, which_page_num) {
        ...
        var filters = _paramsFunc().filters + ";";
        if (!isEmpty(q_word[0])) {
            _paramsFunc().field.split(',').forEach(function (currentValue, index, array) {
                filters += currentValue + "=" + q_word + ";";
            });
        }
        console.log(filters);
        ...
        self.prop.xhr = $.ajax({
            ...
            success: function (returnData) {
                ...
                try {
                    ...
                    json.cnt_whole = data.totalCount;
                } catch (e) {
